...
const exp = (function() {
    ...
    const lowMI_wheel = [ wedges.four, wedges.four, wedges.four, wedges.four, wedges.four, wedges.four, wedges.ten, wedges.ten ];
...
const timeline = [exp.practice, exp.wheel_1, exp.wheel_2, exp.wheel_3, exp.wheel_4, exp.demographics];
